  ...
  projects: [
    {
      ...
      description: "A ERC20 token bridge enabling a 7 hour withdrawal window with almost no trust assumptions, enabled by Kakarot L2",
    ...
    },
    {
      ...
      description: "StarkSprouts is a fully on-chain game using the Dojo toolchain. The goal of the game is simply to grow a garden, which will slowly die, and must be watered to stay alive.",
      achievements: ["Top 10 at Starknet Hacker House Denver"],
      additionalInfo: "Gameplay implemented with ThreeJS, and the game was deployed on Starknet using Slot.",
